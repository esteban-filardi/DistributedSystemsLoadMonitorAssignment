...
void LoadInfoReporter::SendLoadInfo() {
    ...
    auto loadMessage = GetLoadInfoMessage();
    SP_multicast(_mailbox, AGREED_MESS, this->_groupName.c_str(), MT_LOAD_INFO_MESS_TYPE, loadMessage.length(), loadMessage.c_str());
}
